...
1. Gather any documents that describe the different use cases or <a href="/decide/user-scenarios/" class="usa-link">scenarios</a> in which users will interact with your service.
